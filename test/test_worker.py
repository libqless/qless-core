...
class TestWorker(TestQless):
    ...
    def test_basic(self):
        ...
        self.assertEqual(
            self.lua("workers", 2, "worker"), {"jobs": ["jid"], "stalled": {}}
        )
        self.assertEqual(
            self.lua("workers", 2), [{"name": "worker", "jobs": 1, "stalled": 0}]
        )
    ...
    def test_stalled(self):
        ...
        self.assertEqual(
            self.lua("workers", expires, "worker"), {"jobs": {}, "stalled": ["jid"]}
        )
        self.assertEqual(
            self.lua("workers", expires), [{"name": "worker", "jobs": 0, "stalled": 1}]
        )
    ...
    def test_locks(self):
        ...
        self.assertEqual(
            self.lua("workers", expires, "worker"), {"jobs": {}, "stalled": {}}
        )
    ...
    def test_cancelled(self):
        ...
        self.assertEqual(self.lua("workers", 4, "worker"), {"jobs": {}, "stalled": {}})
        self.assertEqual(
            self.lua("workers", 4), [{"name": "worker", "jobs": 0, "stalled": 0}]
        )
    ...
    def test_unregistered(self):
        ...
        self.assertEqual(
            self.lua("workers", 3600, "worker"), {"jobs": {}, "stalled": {}}
        )
