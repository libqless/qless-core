...
class TestEvents(TestQless):
    ...
    def test_track(self):
        ...
        self.assertEqual(self.lua.log, [{"channel": "ql:track", "data": "jid"}])

        with self.lua:
            self.lua("track", 0, "untrack", "jid")
        self.assertEqual(self.lua.log, [{"channel": "ql:untrack", "data": "jid"}])
    ...
    def test_track_canceled(self):
        ...
        self.assertEqual(
            ...
            [
                {
                    "channel": "ql:log",
                    "data": '{"jid":"jid","queue":"queue","event":"canceled","worker":""}',
                },
                {"channel": "ql:canceled", "data": "jid"},
            ],
        )
    ...
    def test_track_fail(self):
        ...
        self.assertEqual(
            ...
            [
                {
                    "channel": "ql:log",
                    "data": '{"message":"mess","jid":"jid","group":"grp","event":"failed","worker":"worker"}',
                },
                {"channel": "ql:failed", "data": "jid"},
            ],
        )
    ...
    def test_track_popped(self):
        ...
        with self.lua:
            self.lua("pop", 0, "queue", "worker", 10)
        self.assertEqual(self.lua.log, [{"channel": "ql:popped", "data": "jid"}])
    ...
    def test_failed_retries_tracked(self):
        ...
        with self.lua:
            self.assertEqual(
                self.lua("retry", 0, "jid", "queue", "worker", 0, "group", "message"),
                -1,
            )
        self.assertEqual(self.lua("get", 0, "jid")["state"], "failed")
        self.assertEqual(self.lua.log, [{"channel": "ql:failed", "data": "jid"}])
    ...
    def test_advance(self):
        ...
        self.lua("pop", 0, "queue", "worker", 10)
        with self.lua:
            self.lua("complete", 0, "jid", "worker", "queue", {}, "next", "queue")
        self.assertEqual(
            self.lua.log,
            [
                {
                    "channel": "ql:log",
                    "data": '{"jid":"jid","to":"queue","event":"advanced","queue":"queue"}',
                }
            ],
        )
    ...
    def test_config_unset(self):
        ...
        self.assertEqual(
            self.lua.log,
            [{"channel": "ql:log", "data": '{"event":"config_unset","option":"foo"}'}],
        )
    ...
    def test_cancel_running(self):
        ...
        self.assertEqual(
            ...
            [
                {
                    "channel": "ql:log",
                    "data": '{"jid":"jid","queue":"q","event":"canceled","worker":"wrk"}',
                },
                {
                    "channel": "ql:w:wrk",
                    "data": '{"jid":"jid","queue":"q","event":"canceled","worker":"wrk"}',
    ...
    def test_cancel_depends(self):
        ...
        self.assertEqual(
            ...
            [
                {
                    "channel": "ql:log",
                    "data": '{"jid":"b","queue":"queue","event":"canceled","worker":""}',
                }
            ],
        )
