...
class TestComplete(TestQless):
    ...
    def test_complete_previously_failed(self):
        ...
        self.assertEqual(
            self.lua("get", 5, "jid")["failure"],
            {"group": "group", "message": "message", "when": 2, "worker": "worker"},
        )
    ...
    def test_advance(self):
        ...
        self.assertEqual(self.lua("pop", 3, "foo", "worker", 10)[0]["jid"], "jid")
    ...
    def test_advance_empty_array_mangle(self):
        ...
        self.lua("pop", 1, "queue", "worker", 10)
        self.lua("complete", 2, "jid", "worker", "queue", "[]", "next", "foo")
        self.assertEqual(self.lua("pop", 3, "foo", "worker", 10)[0]["data"], "[]")
