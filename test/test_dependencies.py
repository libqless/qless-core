...
class TestDependencies(TestQless):
    ...
    def test_unlock(self):
        ...
        self.assertEqual(self.lua("pop", 3, "queue", "worker", 10)[0]["jid"], "b")
    ...
    def test_complete_depends(self):
        ...
        self.lua(
            "complete", 3, "b", "worker", "queue", {}, "depends", ["a"], "next", "queue"
        )
    ...
    def test_cancel_incomplete_chain(self):
        ...
        self.assertRaisesRegexp(
            redis.ResponseError, r"is a dependency", self.lua, "cancel", 3, "a", "b"
        )
    ...
    def test_reput_dependency(self):
        ...
        self.assertEqual(self.lua("pop", 9, "queue", "worker", 10)[0]["jid"], "c")
