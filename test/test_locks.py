...
class TestLocks(TestQless):
    ...
    def test_lose_lock(self):
        ...
        self.assertEqual(
            self.lua("pop", job["expires"] + 10, "queue", "another", 10),
            [
                {
                    "data": "{}",
                    "dependencies": {},
    ...
    def test_heartbeat(self):
        ...
        self.assertTrue(self.lua("heartbeat", 3, "jid", "worker", {}) > job["expires"])
    ...
    def test_heartbeat_depends(self):
        ...
        self.assertRaisesRegex(
            redis.ResponseError, r"depends", self.lua, "heartbeat", 0, "b", "worker", {}
        )
...
class TestRetries(TestQless):
    ...
    def test_reset_complete(self):
        ...
        self.assertEqual(self.lua("pop", 0, "queue", "worker", 10)[0]["remaining"], 5)
...
class TestRetry(TestQless):
    ...
    def test_retry_delay(self):
        ...
        self.lua("put", 0, "worker", "queue", "jid", "klass", {}, 0)
        self.lua("pop", 0, "queue", "worker", 10)
        self.lua("retry", 0, "jid", "queue", "worker", 10)
...
class TestGracePeriod(TestQless):
    ...
    def test_repeated(self):
        ...
        for _ in range(10):
            ...
            expires = job["expires"] + 10
            self.assertEqual(self.lua("pop", expires, "queue", "worker", 10), {})
            # However, once the grace period passes, we should be fine
            job = self.lua("pop", expires + self.grace, "queue", "worker", 10)[0]
